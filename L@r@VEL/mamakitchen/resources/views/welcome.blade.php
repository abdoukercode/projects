...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="frontend/images/Logo_main.png" class="logo img-responsive">
                    </a>
                </div>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item breakfast">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food2.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Prawn Dish</h3>
                                ...
                                <li class="item desert">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food3.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Salad Dish</h3>
                                ...
                                <li class="item breakfast special">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food4.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Prawn Dish</h3>
                                ...
                                <li class="item breakfast">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food5.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                ...
                                <li class="item dinner special">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food6.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Chicken Dish</h3>
                                ...
                                <li class="item desert">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food7.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                ...
                                <li class="item dinner">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food8.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Special Salad</h3>
                                ...
                                <li class="item desert special">
                                    ...
                                    <a href="#">
                                        <img src="frontend/images/food9.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Ice-cream</h3>
        ...
        <section id="great-place-to-enjoy" class="great-place-to-enjoy">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="frontend/images/icons/beer_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <section id="beer" class="beer">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="frontend/images/icons/beer_color.png">
            <div class="container-fluid">
                <div class="row dis-table">
        ...
        <section id="breakfast" class="breakfast">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="frontend/images/icons/bread_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="bread" class="bread">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="frontend/images/icons/bread_color.png">
            <div class="container-fluid">
                <div class="row dis-table">
                    <div class="hidden-xs col-sm-6 dis-table-cell section-bg">
        ...
        <section id="have-a-look" class="have-a-look hidden-xs">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="frontend/images/icons/food_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="menu-gallery" style="width: 50%; float:left;">
                            <div class="flexslider-container">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu1.png" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu2.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu3.png" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu4.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu5.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu6.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu7.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu8.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu9.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu10.jpg" />
                                        </li>
                                        <li>
                                            <img src="frontend/images/menu-gallery/menu11.jpg" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
